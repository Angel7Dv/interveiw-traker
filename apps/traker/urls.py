...
from .views import dashboard, vacant, enterprise, interview, post_interview, networking #add_networking
urlpatterns = [
    ...
    path(r'add_interview/<str:vacant_slug>/', post_interview, name="post_interview"),
